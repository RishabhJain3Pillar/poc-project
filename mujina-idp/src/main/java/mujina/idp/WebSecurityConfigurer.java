...
public class WebSecurityConfigurer implements WebMvcConfigurer {
  ...
  protected static class ApplicationSecurity extends WebSecurityConfigurerAdapter {
    ...
    //@Autowired
    //private FederatedUserAuthenticationToken federatedUserAuthenticationToken;
    ...
    public DaoAuthenticationProvider authenticationProvider() {
        ...
        //new CustomDaoAuthenticationProvider(idpConfiguration);
        //authProvider.authenticate(new IdpAuthentication());
